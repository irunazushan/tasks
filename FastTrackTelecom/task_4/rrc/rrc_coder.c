...
void RRCConnectionRequest_coder(uint8_t **buffer, ssize_t *len) {
  ...
  conReq->criticalExtensions.choice.rrcConnectionRequest_r8.ue_Identity
      .present = InitialUE_Identity_PR_randomValue;
  conReq->criticalExtensions.present =
      RRCConnectionRequest__criticalExtensions_PR_rrcConnectionRequest_r8;
  conReq->criticalExtensions.choice.rrcConnectionRequest_r8.establishmentCause =
  ...
  conReq->criticalExtensions.choice.rrcConnectionRequest_r8.ue_Identity.choice
      .randomValue.buf = bufNum;
  conReq->criticalExtensions.choice.rrcConnectionRequest_r8.ue_Identity.choice
      .randomValue.size = randomValueSize;

  asn_encode_to_new_buffer_result_t res = {NULL, {0, NULL, NULL}};
  res = asn_encode_to_new_buffer(NULL, ATS_CANONICAL_XER,
                                 &asn_DEF_RRCConnectionRequest, conReq);
...
void RRCConnectionSetup_coder(uint8_t **buffer, ssize_t *len) {
  ...
  //   conSet->criticalExtensions.choice.c1.choice.rrcConnectionSetup_r8 =
  //       RRCConnectionSetup__criticalExtensions__c1_PR_rrcConnectionSetup_r8;
  asn_encode_to_new_buffer_result_t res = {NULL, {0, NULL, NULL}};
  res = asn_encode_to_new_buffer(NULL, ATS_CANONICAL_XER,
                                 &asn_DEF_RRCConnectionSetup, conSet);
...
void RRCConnectionSetupComplete_coder(uint8_t **buffer, ssize_t *len) {
  ...
  conCmplt = (RRCConnectionSetupComplete_t *)calloc(
      1, sizeof(RRCConnectionSetupComplete_t));
  conCmplt->rrc_TransactionIdentifier = 2;
  //   conCmplt->criticalExtensions.choice.c1.choice.rrcConnectionSetupComplete_r8
  //   = RRCConnectionSetupComplete__criticalExtensions__c1_PR;
  conCmplt->criticalExtensions.choice.c1.choice.rrcConnectionSetupComplete_r8
      .selectedPLMN_Identity = 1;
  asn_encode_to_new_buffer_result_t res = {NULL, {0, NULL, NULL}};
  res = asn_encode_to_new_buffer(NULL, ATS_CANONICAL_XER,
                                 &asn_DEF_RRCConnectionSetupComplete, conCmplt);
